 ...
 */
void RstLow(void){ HAL_GPIO_WritePin(LCD_RS_GPIO_Port, LCD_RS_Pin, GPIO_PIN_RESET); }

/**
 * @brief  Reset pin of LCD is set.
 */
void RstHigh(void){ HAL_GPIO_WritePin(LCD_RS_GPIO_Port, LCD_RS_Pin, GPIO_PIN_SET); }

/**
 * @brief  Enable pin of LCD is reset.
 */
void EnLow(void){ HAL_GPIO_WritePin(LCD_EN_GPIO_Port, LCD_EN_Pin, GPIO_PIN_RESET); }

/**
 * @brief  Enable pin of LCD is set.
 */
void EnHigh(void){ HAL_GPIO_WritePin(LCD_EN_GPIO_Port, LCD_EN_Pin, GPIO_PIN_SET); }

/**
 * @brief  Enable pin of LCD is blinking every 50 usecond.
 */
void EnBlink(void){ EnHigh(); Delay_us(50); EnLow(); Delay_us(50); }

/**
 * @brief  Back light pin of LCD is set.
 */
void BackLightSet(void){ HAL_GPIO_WritePin(LCD_BKL_GPIO_Port, LCD_BKL_Pin, GPIO_PIN_SET); };
...
/*static*/ void Cmd4bit(uint8_t cmd)
{
