...
#define ROTARY_SPC			2	/* SPC: STATE PER CYCLE (2 for ALPS rotary and 4 for other) */
...
//#define KEY_READ			(((uint8_t)((GPIOA->IDR & KEY_GPIOA_MASK)>>10)&0x08) | ((uint8_t)((GPIOC->IDR & GPIO_PIN_14)>>11)&0x07))
//#define KEY_MASK			0x00
//#define KEY_RELEASE_MASK	0x00// Which buttons act when released.
...
static inline void debounce(void)
{
	...
	//static uint8_t vcount_low  = 0x00, vcount_high = 0x00;
